...
<link rel="stylesheet" href="${m:esc(staticContentPath)}/styles/layoutclient.css?cv=<%=TemplateUtil.getAPIVersion()%>">

<%-- <link rel="stylesheet" href="${m:esc(staticContentPath)}/styles/allStyles.css?cv=<%=TemplateUtil.getAPIVersion()%>"> --%>
</head>
<body>
    <header>
        <div class="menu-page">
            <div class="container menu-container">
                <div class="row menu-items">
                    <a class="col-2 logo" href="${m:tcPath()}/store-app/homepage">
                    ...
                    <div class="col-5">
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon1">
                                <button class="search-btn" onclick="updateLink()">
                    ...
                    <div class="col-5 menu-select">
                        <div class="menu-right">
                            <a class="menu-option login-box" href="<%= URLHelper.cartPage() %>">
                                <h6>
                            ...
                            <a class="menu-option cart-box" href="<%= URLHelper.cartPage() %>">
    ...
    <div class="footer-container">
        <div class="row">
            <div class="col-sm-4 col-3 text-center">
                <img class="logov-footer" src="https://www.vnext.vn/img/logo-vnext-footer.svg" alt="VNEXT Logo">
            </div>
