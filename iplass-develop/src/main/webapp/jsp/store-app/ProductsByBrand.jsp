...
<link rel="stylesheet" href="${m:esc(staticContentPath)}/styles/productByBrand.css?cv=<%=TemplateUtil.getAPIVersion()%>">
            ...
            <div class="product-item-container">
                <a href="<%= URLHelper.getProductDetailPath(p.getOid()) %>">
                    <div class="product-image">
                        <img src="<%= URLHelper.getProductImageResource(p, "productImage") %>" alt="">
                    </div>
                    <div class="product-name">
                        <h6><%= p.getName() %></h6>
                    </div>
                    <div class="product-price">
                        <span class="product__price--show"><%= p.getPrice() %></span>
                        <span class="product__price--through"><%= p.getOldPrice() %></span>
                    </div>
